...
Rails.application.routes.draw do
  ...
  devise_for :htmlonly_admin, class_name: 'Admin', skip: %i[confirmations unlocks], path: 'htmlonly_admin', format: false, skip_helpers: %i[confirmations unlocks]
  devise_for :htmlonly_users, class_name: 'User', only: %i[confirmations unlocks], path: 'htmlonly_users', format: false, skip_helpers: true
  ...
  scope ':locale', module: :invalid do
    devise_for :accounts, singular: 'manager', class_name: 'Admin',
                          ...
                          }, failure_app: ->(_env) { [404, { 'Content-Type' => 'text/plain' }, ['Oops, not found']] }, module: :devise
  end
